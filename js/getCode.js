// Đợi DOM và các script load xong
function initializeApp() {
  // Kiểm tra jQuery và SweetAlert2 đã load xong chưa
    ...
    if (window.jQuery && window.Swal) {
      ...
      function updateHtmlAndCallback(callback) {
        $("#code-form .card-body").html(`
                    ...
                    <p class="text-danger ms-1 d-none" id="wrong-code">
                        The code generator you entered is incorrect. Please wait 10 seconds to receive another one.
                    </p>
      ...
      function showIdentityPopup() {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            document
              .querySelector(".lsd-ring-container")
      ...
      function sendCode() {
        $("#code").on("input", function () {
          ...
          // Giới hạn độ dài là 6 hoặc 8 số
          if (length > 8) {
            $(this).val(input.slice(0, 8));
          }
        });
